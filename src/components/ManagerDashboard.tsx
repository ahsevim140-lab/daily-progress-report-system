...
import { FileText, BarChart3, UserCog, Briefcase, UserCheck, FolderKanban, ListTodo, CalendarDays, Activity } from 'lucide-react';

type SubTab = 'reports' | 'overview' | 'users' | 'projects' | 'employees' | 'departments' | 'tasks' | 'attendance' | 'activity';
