...
import { FileText, BarChart3, UserCog, Briefcase, UserCheck, FolderKanban, ListTodo, CalendarDays, Activity, FileDown } from 'lucide-react';

type SubTab = 'reports' | 'overview' | 'builder' | 'users' | 'projects' | 'employees' | 'departments' | 'tasks' | 'attendance' | 'activity';
